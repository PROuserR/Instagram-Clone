...
const CreateUserNamePage = () => {
  ...
  return (
    <div className='flex flex-col items-center text-center space-y-4 p-2'>
        ...
        <input ref={username} className='w-5/6 p-2 bg-zinc-800 rounded-md outline-none' placeholder='Username' type='text' />
        <button className='w-5/6 bg-blue-500 p-2' onClick={() => storeUsername()}>Next</button>
    </div>
  )
}
