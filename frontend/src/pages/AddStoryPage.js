...
const AddStoryPage = () => {
    ...
    const addFiles = () => {
        ...
        setAddStoryBtn(<button onClick={addStory} className='text-lg bg-blue-600 p-1 rounded-md text-black dark:text-white'>Add Story</button>)
    }
    ...
    return (
        <div>
            <section className='flex items-center'>
                ...
                <span className='ml-10 text-xl font-semibold text-black dark:text-white'>Add to story</span>
            </section>
